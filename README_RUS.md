...
В случае если вам не нравятся какие-либо русифицированные моды, которые вы хотите отключить, но русификатор не позволяет, вот гайд, как удалять из русификатора моды [RUS_MOD_DISABLE.md]() 
