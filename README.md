...
Большая сборка модификаций для игры Cataclysm: Dark Days Ahead (0.D-572-gc62f18a- Тайловая Версия)
...
Book Scanner Mod (Удалён) - Добавляет планшет и сканер книг, позволяя делать их электронные копии. (Отмена поддержки LUA. Без него мод бесполезен.)
